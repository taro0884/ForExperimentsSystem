...
public class ex2GameManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        csvFile = Resources.Load("ex2_QA") as TextAsset; // Resouces下のCSV読み込み
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Space))
        {
            ...
            ex2SelectScript.click--;
            SceneManager.LoadScene("ex2_SelectQScene");  //書き換えいるよ
            return;
        }
    ...
    public void AnswerButtonClick()
    {
        ...
        if (UserAnswer == AnswerList[Question_number])
        {
            ...
            if (Question_number == 9)       //複雑単純によって書き換える必要あり
            {
                Debug.Log("aaaa");
                SceneManager.LoadScene("EndScene");
                return;
